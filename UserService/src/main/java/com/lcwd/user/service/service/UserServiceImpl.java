...
RatingService ratingService;
	...
	public User getUser(String userId) {
	 // Fetch user from DB
		    User user = repository.findById(userId).orElseThrow(() -> new ResourceNotFound("User not found on given Id : " + userId));
		    ...
		    log.info("RatingOFUSers{}",ratingsOfUser);
